...
var DBFuncs = {
    ...
    updateStateData: function(tx, results) {
        ...
        console.log("Getting projects: " + DBFuncs.ProjectsURL + DBFuncs.curState);
        ...
        .error(function(err) { stopModelLoading();alert("Update project list error: " + JSON.stringify(err)); })
